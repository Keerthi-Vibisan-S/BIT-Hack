...
class _FacultyHomeState extends State<FacultyHome> {
  ...
  Widget build(BuildContext context) {
    return (Responsive.isMobile(context))
          ? (!isFetchingStudents)
              ? FacultyHomeMobile(data,userdetails,requests,isFetchingRequests,refresh)
              : Container()
          : Scaffold(
      body: getBackground(Row(
        children: [
          ...
          (press1)?getHomePage(userdetails, isFetchingStudents, data):FacultySwitch(userdetails, isFetchingRequests, requests,refresh)
