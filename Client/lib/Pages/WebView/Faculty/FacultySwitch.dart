...
class FacultySwitch extends StatefulWidget {
  ...
  final refresh;
  const FacultySwitch(this.userDetails, this.isFetching, this.data,this.refresh,{Key? key}) : super(key: key);
...
class _FacultySwitchState extends State<FacultySwitch> {
  ...
  Widget build(BuildContext context) {
    ...
    return (Responsive.isMobile(context))?FacultySwitchMobile(widget.data["joining"],widget.data["leaving"],widget.refresh):Expanded(
      flex: 40,
      child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            // color: Colors.orange,
                            child: ((where=="To" && data[index].from_approval == "OK") || (where=="From" && data[index].to_approval == "OK"))
                                ?Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child: Text("Approved"),
                                )
                                :((where=="To" && data[index].from_approval == "CANCEL") || (where =="From" && data[index].to_approval == "CANCEL"))
                                  ?Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text("Canceled"),
                                  )
