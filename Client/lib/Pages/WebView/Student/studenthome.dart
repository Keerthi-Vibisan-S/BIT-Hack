...
import 'package:special_lab_dashboard/Pages/WebView/Student/LabSwitch.dart';
      ...
      body: Container(
          ...
          child: Row(
            children: [
              ...
              (press1)?(!isFetchingHome)?getStudentHome(userdetails, fac_of_lab, isFetchingHome, myLab, inchargeDetails):Container():LabSwitchPage(userdetails, isFetchingSwitch, specialLabsNames, details, myLab, inchargeDetails)
            ],
          ),
      ),
    ),
